...
function clearField(id: string){
    const container: HTMLElement | any = document.getElementById(id);
...
function setRandomValue(id: string){

    const container: HTMLElement | any = document.getElementById(id);
    
    const output: number = currentValue(id);

    container.previousElementSibling.style.visibility = 'hidden';
    container.innerHTML = output;
}

function currentValue(addID: string):number{
...
function checkVisible(id: string): void{
...
function calcRemPoints(){
    const container: HTMLElement | any = document.getElementById('remPoints');

    const output: number = cultStats.points;
...
function ranLucky(){
   ...
   var luckyStat:number = RandomNum(6);
...
function calcLucky(){
    const container: HTMLElement | any = document.getElementById('luckyInput');
...
function saveChar(){
    ...
    let data = 
        ...
        const saveFilename = cultStats.name + ".txt";
